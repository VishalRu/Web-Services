...
namespace Translater.TranslatorService {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Translater.TranslatorService.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public Translater.TranslatorService.TranslationMatch[] Translations {
            get {
    ...
    public interface LanguageService {
        ...
        Translater.TranslatorService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, Translater.TranslatorService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, Translater.TranslatorService.Translation[] translations, string from, string to, Translater.TranslatorService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        Translater.TranslatorService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, Translater.TranslatorService.TranslateOptions options);
        ...
        Translater.TranslatorService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, Translater.TranslatorService.TranslateOptions options);
        ...
        Translater.TranslatorService.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, Translater.TranslatorService.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : Translater.TranslatorService.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<Translater.TranslatorService.LanguageService>, Translater.TranslatorService.LanguageService {
        ...
        public Translater.TranslatorService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, Translater.TranslatorService.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, Translater.TranslatorService.Translation[] translations, string from, string to, Translater.TranslatorService.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public Translater.TranslatorService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, Translater.TranslatorService.TranslateOptions options) {
        ...
        public Translater.TranslatorService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, Translater.TranslatorService.TranslateOptions options) {
            return base.Channel.TranslateArray(appId, texts, from, to, options);
        }
        
        public Translater.TranslatorService.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, Translater.TranslatorService.TranslateOptions options) {
